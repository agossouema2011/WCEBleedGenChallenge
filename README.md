...
- To train the Detection model use:<i> python yolov5/train.py --img 224 --batch 16 --epochs 300 --data dataset.yaml --weights yolov5s.pt</i>
- To Test on an image, use: <i>python yolov5/detect.py --weights yolov5/runs/train/exp/weights/best.pt --conf-thres 0.4 --iou-thres 0.75 --source <i>imagelocation</i></i>
